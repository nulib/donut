class CharacterizeJob < ApplicationJob
  ...
  def perform(file_set, file_id, filepath = nil) # rubocop:disable Metrics/AbcSize
    ...
    CreatePyramidTiffJob.perform_now(file_set) if file_set.class.image_mime_types.include?(file_set.mime_type)
  end
